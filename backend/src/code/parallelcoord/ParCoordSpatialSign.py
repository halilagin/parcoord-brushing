...
class IrisDataSpatialSign(object):
    ...
    def produceSSOfTwoVars(self,n,m):
        self.applySpatialSign()
        x = self.ss[n]
        y = self.ss[m]
        print ("produceSSOfTwoVars", x,y)
        return self.projectOnCircle(x, y)
...
class BreastCancerSpatialSign(object):
    pass
